    ...
    <main>
      ...
      >
        <video
          ...
          playsInline
          preload="metadata"
          poster="/assets/images/nexora-hero-poster.png"
        >
          <source
            src="/assets/video/nexora-hero.mp4"
            type="video/mp4"
          />
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-4">
            {steps.map((step, index) => (
              <div
                ...
                key={step}
              >
                <div className="mb-4 text-2xl font-bold text-[#00D9FF]">
                  0{index + 1}
                </div>
      ...
      >
        <div className="container">
          ...
          <p className="mt-3 text-[#A7B0C0]">
            15 specialized managers operating under controlled
            permissions and real task state.
          </p>
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            {services.map((service) => (
              ...
              >
                ...
                <p className="mt-3 text-[#A7B0C0]">
                  Executed through the NEXORA project workflow
                  and recorded as real system state.
                </p>
              </div>
            ))}
          </div>
      ...
      <footer className="border-t border-[#202A46] px-6 py-12">
        <div className="container flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <p className="text-sm text-[#667085]">
            © NEXORA DIGITAL 2026. All Rights Reserved.
          </p>
        </div>
      </footer>
    </main>
